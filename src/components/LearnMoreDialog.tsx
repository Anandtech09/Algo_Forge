          ...
          <div className="space-y-6">
            ...
            {item.complexity && (
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-lg mb-3">Complexity Analysis</h3>
            ...
            {/* Applications */}
            <div>
              <h3 className="font-semibold text-lg mb-3">Common Applications</h3>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-3">Detailed Explanation</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-semibold text-lg">Python Implementation</h3>
                <Button
                  variant="outline"
                  size="sm"
              ...
              <div className="bg-gray-900 rounded-lg overflow-hidden">
                ...
                <pre className="p-4 text-sm overflow-y-auto max-h-100 scrollbar-none">
